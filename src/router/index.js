    ...
    children: [
      {
        ...
        meta: { title: '作业上传', icon: 'documentation' }
      }
    ]
  },
  {
    ...
    children: [
      { path: 'list', component: () => import('@/views/problem/list'), name: 'problemList', meta: { title: '作业列表', icon: 'list' }},
      { path: 'edit/:id', component: () => import('@/views/problem/edit'), name: 'editProblem', meta: { title: '当前作业', noCache: true }, hidden: true }
    ]
  },
  {
    path: '/documentation',
    ...
    children: [{
      ...
      name: 'documentation',
      meta: { title: '学习资料', icon: 'documentation', noCache: true }
    }]
  }/* ,
  {
    path: '/guide',
